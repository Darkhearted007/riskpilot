        ...
        <div style={S.modalOverlay} onClick={() => setShowTerms(false)}>
          <div style={S.modalContent} onClick={e => e.stopPropagation()}>
            ...
            <div style={S.modalBody}>
              ...
              <p><strong>3. License</strong><br/>Upon payment, you receive a personal, non-transferable subscription to use RiskPilot Pro for your individual trading activities. Resale, redistribution, or sharing of your account credentials is strictly prohibited.</p>
              <p><strong>4. Payments & Billing</strong><br/>Payments are processed securely via Paystack. Subscriptions are billed monthly at ₦5,000 (Pro), ₦15,000 (Pro+), or ₦30,000 (Elite) per month. You can cancel anytime and will retain access until your paid period ends.</p>
